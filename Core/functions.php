...
$url = "https://api.telegram.org/bot5436508081:AAHS16iI32cIFj5Bvv2jaQrk5a2ZgjHW4vE/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
